package ru.practicum.notification.security;
    ...
    class JwtAuthenticationConverter {
        ...
        void test1() {
            var jwt = Jwt.withTokenValue("token")
                    .header("alg", "none")
                    .claim("realm_access", Map.of("roles", List.of("ACCOUNT")))
            ...
            assertThat(authorities).contains("ACCOUNT", "CASH", "TRANSFER");
        }
        ...
        void test2() {
            ...
            assertThat(authorities)
                    .doesNotContain("ACCOUNT", "CASH", "TRANSFER");
        }
    }
}
